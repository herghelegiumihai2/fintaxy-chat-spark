...
const Navbar = () => {
  ...
  return (
    <header className={cn("fixed top-0 left-0 right-0 z-50 transition-all duration-300 px-6 py-4", 
      ...
      <div className="container mx-auto flex justify-between items-center">
        ...
        <div className="hidden md:block max-w-2xl mx-auto">
          <Tabs value={activeTab} onValueChange={handleTabChange} className="w-full">
            <TabsList className="w-full grid grid-cols-3 gap-2 p-1.5">
              <TabsTrigger 
                value="business" 
                className="text-sm md:text-base px-4 py-2 rounded-md transition-all hover:bg-fintaxy-light whitespace-nowrap"
              >
        ...
        <button 
          ...
          className="md:hidden text-fintaxy-navy focus:outline-none focus:ring-2 focus:ring-fintaxy-blue focus:ring-opacity-50 rounded"
        ...
        <div className="md:hidden absolute top-full left-0 right-0 bg-white shadow-lg p-4 animate-fade-in">
          <Tabs value={activeTab} onValueChange={handleTabChange} className="w-full mb-4">
            <TabsList className="w-full grid grid-cols-1 gap-3">
              <TabsTrigger 
                value="business" 
                className="text-sm w-full py-3 rounded-md transition-all hover:bg-fintaxy-light"
              >
                Proprietari de afaceri
              </TabsTrigger>
              <TabsTrigger 
