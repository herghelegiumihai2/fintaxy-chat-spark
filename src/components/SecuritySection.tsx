...
const SecuritySection = () => {
  ...
  return (
    <section className="py-20 px-6 bg-fintaxy-navy text-white" ref={sectionRef}>
      <div className="container mx-auto max-w-7xl section-appear">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-blue-100 mb-10 leading-relaxed text-lg">
            Folosim securitate de nivel bancar, stocăm datele la un furnizor certificat SOC2, realizăm backup la fiecare oră și 
            respectăm toate standardele majore de securitate. Protejează datele financiare sensibile cu cele mai recente tehnologii 
          ...
          <div className="mt-12 flex justify-center">
            <img 
              src="public/lovable-uploads/2952eed9-2e84-4976-8af4-1594d1b05c51.png" 
              alt="Certificări de securitate" 
