  ...
  return <section ref={sectionRef} className="px-6 bg-gray-50/30 py-0">
      <div className="container mx-auto max-w-screen-xl">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          {/* Card 1 */}
          <div ref={addToRefs} className="stagger-item bg-white rounded-xl p-6 border border-gray-100 shadow-sm hover:shadow-md hover:scale-105 transition-all duration-300">
