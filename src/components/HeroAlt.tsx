      ...
      <div className="container mx-auto max-w-7xl">
        <div className="flex flex-col items-center text-center mb-12 md:mb-16 section-appear">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-[55px] font-semibold leading-tight tracking-[-0.04em] text-fintaxy-navy max-w-4xl mb-6">
            Simplifică-ți afacerea cu soluții AI pentru contabilitate și management
          </h1>
          
          <p className="text-fintaxy-muted text-lg md:text-xl max-w-2xl mb-8 leading-relaxed">
            Fintaxy all-in-one - combină contabilitate, facturare și management al afacerii, toate alimentate de inteligență artificială, 
            special concepute pentru întreprinderile mici și mijlocii (IMM-uri). Concentrează-te pe dezvoltarea afacerii tale, 
            iar noi ne ocupăm de cifre – oricând, oriunde.
          </p>
